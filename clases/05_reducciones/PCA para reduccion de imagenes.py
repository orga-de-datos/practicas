...
# 1. Para cada pixel sumamos los valores de los 3 colores summing RGBs channel values for each pixel
...
# Podemos ver que a partir de 150, las reconstrucciones parecen indistinguibles de la original.
#
#
